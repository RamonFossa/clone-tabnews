  ...
  return (
    ...
    >
      {selectedOption ? (
        ...
        <FirstStep handleClick={handleClick} />
      )}
    </div>
  );
}
...
function SecoundStep(props) {
  ...
  return (
    ...
    >
      ...
      <Checkbox chave={"louca"} handleCheck={handleCheck}>
        Vou lavar toda a louça
      </Checkbox>
      <Checkbox chave={"clean"} handleCheck={handleCheck}>
        Vou limpar toda a casa
      </Checkbox>
      <Checkbox chave={"internship"} handleCheck={handleCheck}>
        Vou pro intecâmbio com você
      </Checkbox>
      <Checkbox chave={"love"} handleCheck={handleCheck}>
        Vou dar e receber muito amor
      </Checkbox>
      <Checkbox chave={"happy"} handleCheck={handleCheck}>
        Vou ser muito feliz
      </Checkbox>
